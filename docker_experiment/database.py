...
def get_connection():
    ...
    In Docker Compose the connection URL is supplied through the
    DATABASE_URL environment variable. This keeps the application
    independent of a specific database host (for example Neon).
    """
